...
Deno.test("typeFromHand", () => {
  ...
  assertEquals(Type.TwoPair, typeFromHand("KTFFT"));
  assertEquals(Type.ThreeOfAKind, typeFromHand("T55F5"));
  assertEquals(Type.ThreeOfAKind, typeFromHand("QQQFA"));
  assertEquals(Type.FourOfAKind, typeFromHand("QQQJA"));
  assertEquals(Type.FullHouse, typeFromHand("23332"));
  assertEquals(Type.FourOfAKind, typeFromHand("33323"));
  assertEquals(Type.FourOfAKind, typeFromHand("T55J5"));
  assertEquals(Type.FourOfAKind, typeFromHand("KTJJT"));
...
Deno.test("totalWinnings", () => {
  assertEquals(5905, totalWinnings(testInput));
});
